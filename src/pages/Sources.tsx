...
export function SourcesPage() {
  return (
    <article className="max-w-2xl">
      <p className="m-0 text-[0.7rem] uppercase tracking-[0.22em] text-tyrian">Method</p>
      ...
      <section className="mt-10">
        <h2 className="font-display text-xl font-semibold">How a figure gets onto the page</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-ink/80">
          <li>Open the Home Department White Book (detailed budget estimates) on BEAMS.</li>
          <li>Read the printed amount in thousands of rupees.</li>
          <li>Convert to crore by dividing by 10,000 (1 crore = 10,000 thousand rupees).</li>
          <li>Store the rupee integer, the series (Actuals / Budget / Revised), the year, and the page.</li>
        </ol>
        <p className="mt-4 text-sm text-ink/65">Extracted {EXTRACT_DATE}.</p>
      </section>

      <section className="mt-10">
        <h2 className="font-display text-xl font-semibold">White Book status</h2>
      ...
      <section className="mt-10">
        <h2 className="font-display text-xl font-semibold">Two layers, never mixed</h2>
      ...
      <section className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-ink/80">
          ...
          <li>This is Maharashtra Police, not all Indian police, and not Union forces.</li>
          <li>Mumbai Police is state police. There is no municipal corporation slice here.</li>
          <li>
          ...
          <li>Numbers freeze at extract date. They are not a live feed from the treasury.</li>
        </ul>
      </section>
